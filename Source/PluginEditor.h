...
/* https://forum.juce.com/t/draggabletabbedcomponent/13265/6
 You can create a subclass of TabbedButtonBar which is also a DragAndDropTarget. And you can create
 custom tab buttons which allow themselves to be dragged.
 */
...
{
    HorizontalContrainer(std::function<juce::Rectangle<int>()> confinerBoundsGetter,
...
struct ExtendedTabBarButton : juce::TabBarButton
{
    ...
    std::unique_ptr<HorizontalContrainer> constrainer;
